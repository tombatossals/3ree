...
const store = compose(applyMiddleware(thunkMiddleware, loggerMiddleware), reduxReactRouter({ createHistory }), devTools())(createStore)(reducers, initialState);
ReactDOM.render(React.createElement("div", null, React.createElement(Provider, {"store": store}, React.createElement(ReduxRouter, null, routes))), document.getElementById('app'));
